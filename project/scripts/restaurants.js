...
const restaurants = [
  {
    id: "restaurant-1",
    name: "Chambo Delight",
    image: "images/chambo-fish-2.jpeg",
    ...
    <div class="restaurant-details-content">
      ...
      <div class="details-text">
        ...
        <div class="details-meta">
          <p><i class="fas fa-map-marker-alt"></i> ${restaurant.location}</s>
          <p class="rating">
            ${generateStarRating(restaurant.rating)}
          </p>
        </div>
        ...
        <p>Email: <a href="mailto:${restaurant.contact.email}">${restaurant.contact.email}</a></p>
        <p>Website: <a href="${restaurant.contact.website}" target="_blank">${restaurant.contact.website}</a></p>
        <h4>Location</h4>
        <iframe
